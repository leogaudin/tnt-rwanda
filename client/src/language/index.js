		...
		resources: {
			en: {
				translation: {
					...
					projectEmailsDescription: 'The emails associated with each project, i.e. the emails to send a daily report to, comma-separated (,). This feature only works if the TnT server has been configured accordingly beforehand.',
			...
			fr: {
				translation: {
					...
					projectEmailsDescription: 'Les emails associés à chaque projet, c\'est-à-dire les emails à qui envoyer un rapport quotidien de ces projets, séparés par une virgule (,). Cette fonctionnalité ne fonctionne que si le serveur TnT a été préalablement configuré en conséquence.',
